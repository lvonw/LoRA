...
class LoRAFinetuneRecipeSingleDevice(FTRecipeInterface):
    ...
    def setup(self, 
              cfg: DictConfig, 
              dataset,
              # NOTE: This was added for the showcase
              tokenizer) -> None:
        """
        ...
        # Sometimes the tokenizer comes in unexpected formats, so its better
        # if we instantiate it beforehand
        self._tokenizer = tokenizer #config.instantiate(cfg.tokenizer)
    ...
    def _setup_data(
        ...
        """
        # Torchtune will normally create the dataset itself, if we want to use
        # a custom dataset we dont need this
        ...
        dataloader = DataLoader(
            ...
            collate_fn=(
                partial(
                    collate_fn,
                    padding_idx=self._tokenizer.eos_token_id,
