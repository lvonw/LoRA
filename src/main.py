...
Frage: "[Fragetext]"
Antwort: "[Antworttext]"
entsprechen. Beinhalte in deiner antwort sonst keinen text. Die Antworten sollen immer so kurz wie möglich gehalten werden. Halte außerdem deine Antworten im JSON Format. Verzichte bitte zusätlich auf jegliche nicht JSON konforme zusätze in deiner Antwort
